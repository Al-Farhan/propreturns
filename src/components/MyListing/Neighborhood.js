...
const Neighborhood = ({ walkscore, transitscore, bikescore}) => {
  return (
    <div className='my-8 border-b'>
        ...
        <div className="flex justify-between">
            <div className='flex flex-col justify-center items-center gap-y-2 my-4'>
                ...
                <p className="text-[#88979E] text-sm"><span className="text-[#2fa8ff] hover:text-[#5FAAFF] hover:cursor-pointer font-semibold">{walkscore}</span> / 100</p>
            ...
            <div className='flex flex-col justify-center items-center gap-y-2 my-4'>
                ...
                <p className="text-[#88979E] text-sm"><span className="text-[#2fa8ff] hover:text-[#5FAAFF] hover:cursor-pointer font-semibold">{transitscore}</span> / 100</p>
                <p className="text-xs text-[#88979E]">Some Transit</p>
            </div>
            <div className='flex flex-col justify-center items-center gap-y-2 my-4'>
                <p className='text-[#88979E] text-sm'>Bike Score</p>
                <FaBicycle color="#515B60" size={30} />
                <p className="text-[#88979E] text-sm"><span className="text-[#2fa8ff] hover:text-[#5FAAFF] hover:cursor-pointer font-semibold">{bikescore}</span> / 100</p>
